# content-engine (DEPRECATED — migrated to broomva/skills monorepo)
...
```bash
npx skills add broomva/skills --skill content-engine
```

## Skill home (new)

[broomva/skills/skills/content-engine](https://github.com/broomva/skills/tree/main/skills/content-engine)
